...
public class TestConstant {
    ...
    public static final String USER_FILE = "file/users.txt";
    public static final String RECORD_FILE = "file/students.txt";
    public static final String INVALID_FILE_NAME = "file/noSuchFile.txt";
